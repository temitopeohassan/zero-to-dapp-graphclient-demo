...
import type { ZeroToDappDemoTypes } from './sources/Zero to dapp demo/types';
...
export type MeshContext = ZeroToDappDemoTypes.Context & BaseMeshContext;
...
export type GetTransfersQuery = { transfers: Array<Pick<Transfer, 'id' | 'sender' | 'receiver' | 'amount'>> };


export const GetTransfersDocument = gql`
    query GetTransfers {
  transfers(first: 10, where: {id: "transactionHash"}) {
    id
    sender
    receiver
    amount
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetTransfers(variables?: GetTransfersQueryVariables, options?: C): Promise<GetTransfersQuery> {
      return requester<GetTransfersQuery, GetTransfersQueryVariables>(GetTransfersDocument, variables, options) as Promise<GetTransfersQuery>;
    }
  };
}
